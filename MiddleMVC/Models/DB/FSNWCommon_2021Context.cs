...
{
    public partial class FSNWCommon_2021Context : DbContext
    {
        public FSNWCommon_2021Context()
        {
        }

        public FSNWCommon_2021Context(DbContextOptions<FSNWCommon_2021Context> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<TblFlower> TblFlowers { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUser>(entity =>
            {
                ...
                entity.Property(e => e.PasswordHint).HasMaxLength(50);
            ...
            modelBuilder.Entity<TblFlower>(entity =>
            {
                entity.HasKey(e => e.FlowerId);

                entity.ToTable("tblFlower");

                entity.Property(e => e.FlowerId)
                    .ValueGeneratedNever()
                    .HasColumnName("FlowerID");

                entity.Property(e => e.Flower).HasColumnType("image");
